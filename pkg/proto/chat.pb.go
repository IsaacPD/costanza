...
const file_proto_chat_proto_rawDesc = "" +
	"\n" +
	"\x10proto/chat.proto\x12\bcostanza\";\n" +
	"\vChatMessage\x12\x12\n" +
	"\x04user\x18\x01 \x01(\tR\x04user\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent2G\n" +
	"\vChatService\x128\n" +
	"\x04Chat\x12\x15.costanza.ChatMessage\x1a\x15.costanza.ChatMessage(\x010\x01B\tZ\a./protob\x06proto3"
